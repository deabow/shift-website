      ...
      <article className="overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/90 shadow-[0_12px_60px_rgb(0,0,0,0.5)] backdrop-blur-2xl">
        <header className="border-b border-white/10 p-6 md:p-10">
          <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
            <span className="text-xs uppercase tracking-[0.22em] text-emerald-400 font-bold bg-emerald-500/10 border border-emerald-500/20 px-3 py-1 rounded-full">
              {project.category}
            </span>
            ...
            {project.liveUrl && (
              <a
                ...
                className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-emerald-500/20 border border-emerald-400/40 text-emerald-300 text-xs font-bold transition hover:bg-emerald-500 hover:text-zinc-950 hover:shadow-[0_0_25px_rgba(16,185,129,0.5)]"
              >
                <Globe size={14} />
        ...
        <div className="grid gap-5 p-6 md:grid-cols-3 md:gap-6 md:p-10">
          <section className="rounded-2xl border border-white/10 bg-black/30 p-5 md:col-span-1">
            <h2 className="text-lg font-bold text-emerald-400 mb-2">The Challenge</h2>
          ...
          <section className="rounded-2xl border border-white/10 bg-black/30 p-5 md:col-span-1">
            <h2 className="text-lg font-bold text-emerald-400 mb-2">Our Solution</h2>
            <div className="text-sm leading-relaxed text-zinc-300">
          ...
          <section className="rounded-2xl border border-white/10 bg-black/30 p-5 md:col-span-1">
            <h2 className="text-lg font-bold text-emerald-400 mb-2">Final Results</h2>
            <div className="text-sm leading-relaxed text-zinc-300">
        ...
        <section className="border-y border-white/10 bg-black/20 px-6 py-8 md:px-10">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {project.keyFeatures.map((feature) => (
              <div
                key={feature}
                className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-4 py-3 text-sm font-semibold text-emerald-300"
              >
                {feature}
              </div>
            ))}
        ...
        <div className="px-6 pb-10 pt-8 md:px-10 flex flex-col sm:flex-row gap-4">
          {project.liveUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-500 px-6 py-4 text-center text-sm font-extrabold uppercase tracking-wider text-zinc-950 shadow-[0_12px_35px_rgba(16,185,129,0.45)] transition hover:bg-emerald-400"
            >
              <Globe size={18} />
          ...
          <OpenChatButton className="flex-1 rounded-2xl border border-white/20 bg-zinc-900 px-6 py-4 text-center text-sm font-extrabold uppercase tracking-wider text-white transition hover:border-emerald-500/50 hover:bg-zinc-800">
