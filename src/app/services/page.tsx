...
function ServiceCard({ service }: { service: ServiceCardData }) {
  ...
  return (
    <motion.article
      ...
      className="group relative flex flex-col justify-between overflow-hidden rounded-3xl p-[1px] bg-white/[0.08] transition-all duration-500 hover:shadow-[0_0_50px_rgba(16,185,129,0.15)]"
    >
        ...
        <div className="pt-6 border-t border-white/[0.06] flex items-center justify-between">
          <MagneticWrapper distanceMultiplier={0.25}>
            <a
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-emerald-500/10 border border-emerald-500/20 px-5 py-2.5 text-xs font-bold uppercase tracking-[0.16em] text-emerald-400 transition-all duration-300 hover:bg-emerald-500 hover:text-zinc-950 hover:shadow-[0_0_30px_rgba(16,185,129,0.4)]"
            >
...
export default function ServicesPage() {
  return (
    <main className="relative mx-auto min-h-[calc(100vh-96px)] w-full max-w-6xl px-4 pb-24 pt-12 md:px-8">
      {/* Ambient lighting */}
      <div className="pointer-events-none absolute left-1/2 top-0 -z-10 h-[600px] w-[800px] -translate-x-1/2 rounded-full bg-emerald-500/5 blur-[200px]" />
      ...
      >
        ...
        <div className="mt-8 h-px w-32 bg-gradient-to-r from-transparent via-emerald-500/50 to-transparent" />
      </motion.header>
      ...
      >
        ...
        <MagneticWrapper distanceMultiplier={0.3} className="relative z-10 shrink-0">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-xl bg-emerald-500 px-6 py-3.5 text-xs font-extrabold uppercase tracking-[0.16em] text-zinc-950 transition hover:shadow-[0_0_35px_rgba(16,185,129,0.5)] hover:bg-emerald-400"
          >
