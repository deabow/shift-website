...
export const REAL_PORTFOLIO_ITEMS: PortfolioItem[] = [
  {
    ...
    titleEn: "4K Aerial Drone Cinematography — Commercial Malls",
    ...
    descriptionAr: "تصوير جوي سينمائي بالدرون بدقة 4K فائقة يبرز فخامة المعمار ومواقع المشروعات الاستثمارية ونسب الإنجاز لجذب كبار المستثمرين.",
    descriptionEn: "4K aerial cinematography and color grading highlighting architectural scale and prime commercial investment locations.",
    imageUrl: "/portfolio-media/khaleej-real-estate-compilation-cover.jpeg",
    videoUrl: "https://vimeo.com/1217314483",
    tagAr: "تصوير درون 4K • مونتاج سينمائي",
    tagEn: "4K Drone • Color Grading",
