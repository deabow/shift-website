...
import { Shield, Code2, Target, Video } from "lucide-react";
  ...
  const services = [
    {
      ...
      icon: Code2,
      className: "md:col-span-2 bg-zinc-900/40 border-blue-500/20 hover:border-blue-500/50",
    ...
    },
    {
      ...
      icon: Target,
      className: "md:col-span-1 bg-zinc-900/40 border-emerald-500/20 hover:border-emerald-500/50",
    ...
    },
    {
      ...
      icon: Video,
      className: "md:col-span-1 bg-zinc-900/40 border-purple-500/20 hover:border-purple-500/50",
      iconColor: "text-purple-400",
    },
    {
      title: t.services.items.cyber.title,
      description: t.services.items.cyber.desc,
      icon: Shield,
      className: "md:col-span-2 bg-zinc-900/40 border-rose-500/20 hover:border-rose-500/50",
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        <div className={`w-12 h-12 rounded-xl bg-zinc-800/50 flex items-center justify-center mb-6 border border-white/5 group-hover:scale-110 transition-transform duration-300`}>
